...
def generate_launch_description():
    ...
    pub_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
                os.path.join(get_package_share_directory('pubsub_example'), 'launch', 'publisher_node.launch.py')
        )
    )

    sub_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
                os.path.join(get_package_share_directory('pubsub_example'), 'launch', 'subscriber_node.launch.py')
        ),
    )
